...
public class MessageDAO {
	...
	public Message findById(java.lang.Integer id) {
		...
		try {
			Message instance = (Message) getCurrentSession().get("ourmarket.models.Message", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Message instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("ourmarket.models.Message").add(Example.create(instance))
					.list();
