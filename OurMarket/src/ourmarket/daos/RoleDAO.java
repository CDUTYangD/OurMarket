...
public class RoleDAO {
	...
	public Role findById(java.lang.Short id) {
		...
		try {
			Role instance = (Role) getCurrentSession().get("ourmarket.models.Role", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Role instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("ourmarket.models.Role").add(Example.create(instance))
					.list();
