...
public class CollectionDAO {
	...
	public void update(Collection transientInstance) {
		log.debug("updateing Collection instance");
		try {
	...
	public Collection findById(java.lang.Integer id) {
		...
		try {
			Collection instance = (Collection) getCurrentSession().get("ourmarket.models.Collection", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Collection instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("ourmarket.models.Collection")
