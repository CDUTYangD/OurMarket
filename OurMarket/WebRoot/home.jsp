...
<script type="text/javascript"
	src="http://webapi.amap.com/maps?v=1.4.0&key=168484ce0ca0e0fb381b1dd319ad121e"></script>
...
<body>
	...
	<div id="wrapper">
		<!-- Navigation -->
		<nav class="top1 navbar navbar-default navbar-static-top form-inline"
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="bought"><i class="fa fa-envelope nav_icon"></i>购物管理</a>
						<!-- /.nav-second-level --></li>
					<li><a href="orderManage"><i class="fa fa-flask nav_icon"></i>销售管理</a>
					</li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
					...
					<form action="" class="form col-md-12 center-block " method="post">
						<div class="form-group" style="border: 1px solid #D0D6D9">
							<input type="text" name="UserID" id="User"
								class="form-control input-lg" placeholder="电子邮件&账号">
						</div>
						<div class="form-group" style="border: 1px solid #D0D6D9">
						...
						<div class="form-group">
							<button class="btn btn-primary btn-lg btn-block" type="submit"
								formaction="Appraise">立刻登录</button>
							<span><a href="#">找回密码</a></span> <span><a
								href="View/signUp.jsp" class="pull-right">注册</a></span>
						</div>
					</form>
				</div>
...
<script type="text/javascript">
    ...
    function sendMySearch(str){
	   var temp = document.createElement("form");
	   temp.action ="http://localhost:8080/OurMarket/searchGoods";        
	    temp.method = "post";        
	    temp.style.display = "none";               
	    var input3=document.createElement("input");
	   input3.name="searchInfo";
	   input3.value=str;
