...
<body style="background:#eff7ff;">
	...
	<div class="content" style="height: 550px;margin:30px ;margin-bottom: 0px;">
		...
		<div class="col-md-4 "style="height: 550px;font-size: 18px;">
			...
			<ul class="list-unstyled"style="color: black;">
				...
				<li>
					<span >交易方式：</span>
					<label style="letter-spacing: normal; font-size: 14px;color:#333333"><input type="radio"  name="transaction"/>线上</label>
					<label style="letter-spacing: normal; font-size: 14px;color:#333333"><input type="radio"  name="transaction"/>线下</label>
				</li>
			</ul>
			<button class="btn btn-block btn-lg btn-warning" style="margin-top: 70px;">立即购买</button>
		</div>
	</div>
	<hr />
	
	<div class="col-md-7" style="margin-left:30px ;margin-right: 30px;border:1px solid  #E0E0E0;background:#eff7ff;">
		<ul id="myTab" class="nav nav-tabs">
			<li class="active">
				<a href="#introduction" data-toggle="tab">宝贝介绍</a>
			</li>
			<li >
				<a href="#apparise" data-toggle="tab">评价</a>
			</li>
		</ul>
	...
	<div class="col-md-4" style="height: 450px;border: groove;	margin-top: 30px;">
