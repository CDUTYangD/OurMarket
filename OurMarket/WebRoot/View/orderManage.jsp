...
<body>
		...
		<div class="row">
			...
			<div id="navbar-left" class="col-sm-2 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="orderManage">订单管理&nbsp;&nbsp;&nbsp;&nbsp;<span
	...
	<c:forEach items="${orderInfos}" var="orderInfo">
		<form action="sendgoods" method="post" name="sendgoodsform">
		<input type="hidden" name="oID" value="${orderInfo.getOid() }" />
			<div
				...
				<div class="hidden-xs 	" style="width: 100%;">
					<div id="orderbox1" style="background-color: ;overflow: hidden;">
						...
						<div id="picture1"
							style="float: left;width: 50%;background-color: ;">
							<br /> <img src="<%=basePath%>/${orderInfo.getGimg()}"
								style="float: right;width: 300px;height: 250px;border: 3px dashed black;" />
						</div>
						<div id="text1"
							style="float: right;width: 47%;background-color: ;">
							<div id="text1style"
								style="font-size: x-large;font-family: 楷体;font-weight: bold;">
								<br /> <br />
								<li>商品名称:<u>${orderInfo.getGname() }</u></li>
								<li>单价:<u>${orderInfo.getGprice() }RMB</u></li>
								<li>数量:<u>${orderInfo.getGnum() }</u></li>
								<li>合计:<u>${orderInfo.getGallprice() }RMB</u></li>
							</div>
						</div>
					</div>
					<div id="orderbox2" style="background-color: ;width: 100%;">
						...
						<div id="text2"
							style="padding-left:70px;width: 50%;background-color: ;margin: 0px auto;">
							<div id="text2style"
								style="font-size: x-large;font-weight: bold;font-family: 楷体;">
								<li>订单号:<u>${orderInfo.getOno() }</u></li>
								<li>创建时间:<u>${orderInfo.getOtime() }</u></li>
								<li>用户名:<u>${orderInfo.getUname() }</u></li>
								<li>联系电话:<u>${orderInfo.getUphone() }</u></li>
								<li>联系QQ:<u>${orderInfo.getUqq() }</u></li>
							</div>
						</div>
				...
				<div class="hidden-lg hidden-md hidden-sm  	" style="width: 100%;">
					<div id="telpicture" style="text-align: center;overflow: hidden;">
						<br /> <img src="img/desk.jpg"
							style="height: 200px;height: 250px;border: 3px dashed black;" />
					</div>

					<div id="teltext1"
						style="background-color: ;margin: 0px auto;width: 80%;">
						<div id="teltext1style"
							style="padding-left:20px;font-size: large;font-weight: bold;font-family: 楷体;">
					...
					<div style="text-align: center;">
						<br /> <br />
						<button onclick="window.location.href='orderManage.jsp'"
							type="submit" class="btn btn-success">确认发货</button>
					</div>
				</div>
			</div>
		</form>
