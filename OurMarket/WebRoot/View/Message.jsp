...
<div class="container-fluid">
		...
		<div class="row">
			...
			<div  id="navbar-middle" class="col-sm-3 col-md-2  " >
				...
				<ul class="list-unstyled" style="border:1px solid #96c2f1;background:#eff7ff; margin-top: 5px;">
					<li class="active"><a href="SystemMessage.html"><i class="fa fa-comment fa-lg"></i>系统消息</a></li>
		...
		<div   class="col-sm-5 col-md-6 " style="margin-top: 5px; margin-top: 5px;padding: 0px;">
			<ul class="content-reply-box mg " id="chatlog" >
				<li class="odd">
				<a class="user" href="#"><img class="img-responsive avatar_" src="../img/2.png" alt=""><span class="user-name"></span></a>
