...
<body onload="init()">
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			<div id="logoDiv">
				<p id="logoP">
					<img id="logo" alt="" src="./img/logo.png"><span>欢迎来到二手网</span>
				</p>
			</div>
			<div id="personInfor">
				<p id="userName">
					<img alt="" src="./img/person.png">张三
				</p>
				<p>
					<img alt="" src="./img/adress.png">四川省成都理工大学
				</p>
				<p>
					<a>退出登录</a>
				</p>
						...
						<center>
							<div class="carousel-inner" role="listbox">
								<div class="item active">
									<img class="first-slide" src="img/alipay_logo.png"
										alt="First slide">
								</div>
								<div class="item">
									<img class="second-slide" src="img/alipay_logo.png"
										alt="Second slide">
								</div>
								<div class="item">
									<img class="third-slide" src="img/alipay_logo.png"
										alt="Third slide">
								</div>
							</div>
						</center>
